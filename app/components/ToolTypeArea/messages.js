/*
 * ToolTypeArea Messages
 *
 * This contains all the text for the ToolTypeArea component.
 */
import { defineMessages } from 'react-intl';

export default defineMessages({
  header: {
    id: 'app.components.ToolTypeArea.header',
    defaultMessage: 'This is the ToolTypeArea component !',
  },
  allHead: {
    id: 'app.components.ToolTypeArea.allHead',
    defaultMessage: 'All',
  },
  storyHead: {
    id: 'app.components.ToolTypeArea.storiesHead',
    defaultMessage: 'Stories',
  },
  storyDesc: {
    id: 'app.components.ToolTypeArea.storiesDesc',
    defaultMessage: 'Accounts of memorable actions and campaigns, analysing what worked, or didn’t, and why.',
  },
  storyLong: {
    id: 'app.components.ToolTypeArea.storiesLong',
  ...
  tacticHead: {
    id: 'app.components.ToolTypeArea.tacticsHead',
    defaultMessage: "Tactics"
  },
  tacticDesc: {
    id: 'app.components.ToolTypeArea.tacticsDesc',
    defaultMessage: 'Specific forms of creative action, such as a flash mob or blockade.',
  },
  tacticLong: {
    id: 'app.components.ToolTypeArea.tacticsLong',
  ...
  principleHead: {
    id: 'app.components.ToolTypeArea.principlesHead',
    defaultMessage: "Principles"
  },
  principleDesc: {
    id: 'app.components.ToolTypeArea.principlesDesc',
    defaultMessage: 'Time-tested guidelines for how to design successful actions and campaigns.',
  },
  principleLong: {
    id: 'app.components.ToolTypeArea.principlesLong',
  ...
  theoryHead: {
    id: 'app.components.ToolTypeArea.theoriesHead',
  ...
  methodologyHead: {
    id: 'app.components.ToolTypeArea.methodologiesHead',
    defaultMessage: "Methodologies"
  },
  methodologyDesc: {
    id: 'app.components.ToolTypeArea.methodologiesDesc',
    defaultMessage: 'Strategic frameworks and hands-on exercises to help you assess your situation and plan your campaign.',
  },
  methodologyLong: {
    id: 'app.components.ToolTypeArea.methodologiesLong',
